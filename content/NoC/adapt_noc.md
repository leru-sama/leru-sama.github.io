...
![Adapt-NoC总体结构](figure/9407201/adaptable_NoC_overview.jpg)
...
![adaptable router and adaptable link](figure/9407201/adaptable_router_adaptable_link.jpg)
...
![SubNoC的构造](figure/9407201/constructionOfSubNoC.jpg)
...
这个东西可以作为我的缓存一致性域的高速连接。分点来吧。

- **强缓存一致性域**: 一个HNF，然后多个Core。这样的结构感觉上是适合于星形或者是树形拓扑，具体还得研究研究。
- **弱缓存一致性域**: 应该就是没有HNF？自己每个核心内部处理，这个也得看看
- **无缓存一致性域**: 这个我熟，就得是mesh  
